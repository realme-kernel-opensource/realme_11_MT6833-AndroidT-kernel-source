...
static int panel_osc_mipi_freq_change(void *dsi, dcs_write_gce cb, void *handle, unsigned int en)
{
	...
	if (en == 0) {
		osc_tb7[1] = 0x32, osc_tb7[2] = 0x4C;    // OSC=167MHz@MIPI Speed=1.7Gbps
	} else if (en == 1) {
		osc_tb7[1] = 0x31, osc_tb7[2] = 0x8F;    // OSC=169MHz@MIPI Speed=1.746Gbps
	} else if (en == 2) {
		osc_tb7[1] = 0x32, osc_tb7[2] = 0xE6;    // OSC=169MHz@MIPI Speed=1.7Gbps
	} else if (en == 3) {
		osc_tb7[1] = 0x30, osc_tb7[2] = 0xF9;    // OSC=167MHz@MIPI Speed=1.746Gbps
	}
